...
Public Class stat
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Array.Sort(product_pass)
        Dim j As Int16 = 0, s As Int16 = 0
        For i = border To 0 Step -1
            g1.DrawLine(myPen, j * 2, 0, j * 2, CSng(product_pass(i)))
            j += 1
            s += product_pass(i)
        Next
        g2.DrawImage(bmp, 0, 0)
        Label1.Text = "人均产出" + Str(s / border)
    End Sub
End Class